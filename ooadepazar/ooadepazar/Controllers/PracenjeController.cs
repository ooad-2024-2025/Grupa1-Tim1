...
namespace ooadepazar.Controllers
{
    public class PracenjeController : Controller
    {
        ...
        public PracenjeController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,PraceniID,PratilacID")] Pracenje pracenje)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,PraceniID,PratilacID")] Pracenje pracenje)
        {
            if (id != pracenje.ID)
            {
                return NotFound();

...
namespace ooadepazar.Controllers
{
    public class NarudzbaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DatumNarudzbe,DatumObrade,Status,KorisnikID,ArtikalID,KurirskasluzbaID")] Narudzba narudzba)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DatumNarudzbe,DatumObrade,Status,KorisnikID,ArtikalID,KurirskasluzbaID")] Narudzba narudzba)
        {
            if (id != narudzba.ID)
            {
                return NotFound();

...
namespace ooadepazar.Controllers
{
    public class NotifikacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Sadrzaj,DatumObjave,Procitana,KorisnikId")] Notifikacija notifikacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Sadrzaj,DatumObjave,Procitana,KorisnikId")] Notifikacija notifikacija)
        {
